...
// Introducing the ECharts main module
// import echarts from 'echarts'
const echarts = require('echarts/lib/echarts');
// //Introduce bar chart
require('echarts/lib/chart/bar');
// require('echarts/lib/chart/pie');
// Introduce prompt box and title components
...
const lightBlue = {
  ...
  colorStops: [{
    offset: 0,
    color: 'rgba(41, 121, 255, 1)', // Color at 0%
  }, {
    offset: 1,
    color: 'rgba(0, 192, 255, 1)', // Color at 100%
  }],
...
export default class app extends Component {
  ...
  loadChart() {
    ...
    const option = {
      ...
      xAxis: {
        data: ['average CPU\n Utilization', 'average memory\n Utilization', 'average hard drive\n Utilization'],
        offset: 15,
        axisTick: {
          show: false,
        },
