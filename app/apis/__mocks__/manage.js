...
export const fetchButtonList = createApi(`${path}/${prefix}/resource/button/list`, 'fetchButtonList') // Button permission list
// role management
export const fetchRoleList = createApi(`${path}/${prefix}/role/list`, 'fetchRoleList') // role list
...
export const fetchModuleListInRole = createApi(`${path}/${prefix}/role/resList`, 'fetchModuleListInRole') // Selected module
...
// User Management
export const fetchUserDepttList = createApi(`${path}/${prefix}/dept/list`, 'fetchUserDepttList') // Get the category list on the left side of user management
export const fetchUserList = createApi(`${path}/${prefix}/user/list`, 'fetchUserList') // Get user list
